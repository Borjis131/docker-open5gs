...
Current `CHART_VERSION` value for the Open5GS chart is 0.3.4, using `OPEN5GS_VERSION` v2.7.5 as default.
The `CHART_VERSION` for individual charts is 0.3.3, using `OPEN5GS_VERSION` v2.7.5 as default.
